    ...
    if(isset($_POST['submit']))
        {
            ...
            // Phải chỉnh sửa lại
            $mailer->Username = "tranleuy.kma@gmail.com"; // GMAIL username
            $mailer->Password = "tranleuy"; // GMAIL password
            $mailer->AddAddress($email, $ten); //email người nhận, $email và $ten là 2 biến đc gán bởi $_POST lấy từ trong form
            $mailer->AddCC("tranleuy.kma@gmail.com", "Admin Đom Đóm Shop"); // gửi thêm một email cho Admin

            // Chuẩn bị gửi thư nào
            $mailer->FromName = 'DomDommobile Shop'; // tên người gửi
            $mailer->From = 'tranleuy.kma@gmail.com'; // mail người gửi
            $mailer->Subject = 'Hóa Đơn Xác Nhận Mua Hàng Từ Đom Đóm Shop';
